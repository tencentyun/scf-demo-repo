...
class FacefusionClient(AbstractClient):
    ...
    def FaceFusion(self, request):
        """本介面用於人臉融合，用戶上傳人臉圖片，獲取與範本融合後的人臉圖片。未發布的活動請求頻率限制爲1次/秒，已發布的活動請求頻率限制50次/秒。如有需要提高活動的請求頻率限制，請在控制台中申請。
        >
    ...
    def FuseFace(self, request):
        """本介面用於單臉、多臉融合，用戶上傳人臉圖片，獲取與範本融合後的人臉圖片。檢視 <a href="https://cloud.taifucloud.com/document/product/670/38247" target="_blank">選臉融合接入指引</a>。
