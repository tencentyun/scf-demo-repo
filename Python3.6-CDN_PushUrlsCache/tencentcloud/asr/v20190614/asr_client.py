...
class AsrClient(AbstractClient):
    ...
    def CreateRecTask(self, request):
        ...
        <br>• 支援中文普通話、英語和粵語。
        <br>• 支援回調或輪詢的方式獲取結果，結果獲取請參考[ 錄音文件識别結果查詢](https://cloud.tencent.com/document/product/1093/37822)。
    ...
    def DescribeTaskStatus(self, request):
        ...
        <br>• 當采用回調方式時，識别完成後會将結果通過 POST 請求的形式通知到用戶在請求時填寫的回調 URL，具體請參見[ 錄音識别結果回調 ](https://cloud.tencent.com/document/product/1093/37139#callback)。
