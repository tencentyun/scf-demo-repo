...
class DescribeSnapshotSharePermissionRequest(AbstractModel):
    ...
    def __init__(self):
        """
        :param SnapshotId: 要查詢快照的ID。可通過[DescribeSnapshots](https://cloud.tencent.com/document/api/362/15647)查詢獲取。
        :type SnapshotId: str
        """
        self.SnapshotId = None
...
class ModifySnapshotsSharePermissionRequest(AbstractModel):
    ...
    def __init__(self):
        """
        :param AccountIds: 接收分享快照的賬号Id清單，array型參數的格式可以參考[API簡介](https://cloud.tencent.com/document/api/213/568)。帳号ID不同于QQ号，查詢用戶帳号ID請檢視[帳号訊息](https://console.cloud.tencent.com/developer)中的帳号ID欄。
        :type AccountIds: list of str
        :param Permission: 操作，包括 SHARE，CANCEL。其中SHARE代表分享操作，CANCEL代表取消分享操作。
        :type Permission: str
        :param SnapshotIds: 快照ID, 可通過[DescribeSnapshots](https://cloud.tencent.com/document/api/362/15647)查詢獲取。
        :type SnapshotIds: list of str
        """
