...
class CreateAccountRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :param InstanceId: 實例 ID，形如：tdsql-ow728lmc，可以通過 DescribeDBInstances 查詢實例詳情獲得。
        :type InstanceId: str
        :param UserName: 登入用戶名，由字母、數字、下劃線和連字元組成，長度爲1~32位。
        :type UserName: str
...
class CreateDBInstanceRequest(AbstractModel):
 ...
 查詢實例規格獲得不同内存大小對應的磁盤規格下限和上限。
        ...
        :param SecurityGroupIds: 安全組ID清單
        :type SecurityGroupIds: list of str
        :param AutoRenewFlag: 自動續約标志，1:自動續約，2:不自動續約
...
class CreateTmpInstancesRequest(AbstractModel):
    """CreateTmpInstances請求參數結構體

    """

    def __init__(self):
        """
        :param InstanceIds: 回檔實例的ID清單，形如：tdsql-ow728lmc。
        :type InstanceIds: list of str
        :param RollbackTime: 回檔時間點
