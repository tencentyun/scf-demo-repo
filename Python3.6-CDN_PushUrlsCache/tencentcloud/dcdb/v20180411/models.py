...
注意當前可售賣的可用區需要通過DescribeDCDBSaleInfo介面拉取。
...
如果不填的話，預設爲10.1.9，表示Mariadb 10.1.9。
        ...
        :param InstanceName: 實例名稱， 可以通過該欄位自主的設置實例的名字
...
注意：此欄位可能返回 null，表示取不到有效值。
        :type Paymode: str
        :param ShardMasterZone: 分片的主可用區
注意：此欄位可能返回 null，表示取不到有效值。
        :type ShardMasterZone: str
        :param ShardSlaveZones: 分片的從可用區清單
注意：此欄位可能返回 null，表示取不到有效值。
...
class DescribeAccountPrivilegesRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type Type: str
        :param Object: 具體的 Type 的名稱，例如 Type 爲 table 時就是具體的表名。DbName 和 Type 都爲具體名稱，則 Object 表示具體對象名，不能爲 \* 或者爲空
        :type Object: str
...
class DescribeDCDBPriceRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type Zone: str
        :param Count: 欲購買實例的數量，目前支援購買1-10個實例
        :type Count: int
        :param Period: 欲購買的時長，單位：月。
        :type Period: int
 ...
 查詢實例規格獲得。
        ...
        :param ShardCount: 實例分片個數，可選範圍2-8，可以通過升級實例進行新增分片到最多64個分片。
        :type ShardCount: int
        :param Paymode: 付費類型。postpaid：按量付費   prepaid：預付費
        :type Paymode: str
        """
        self.Zone = None
        self.Count = None
...
class Project(AbstractModel):
    ...
    def __init__(self):
        ...
        :param ProjectId: 項目ID
        :type ProjectId: int
        :param OwnerUin: 資源擁有者（主賬号）uin
        :type OwnerUin: int
        :param AppId: 應用Id
        :type AppId: int
        :param Name: 項目名稱
        :type Name: str
        :param CreatorUin: 創建者uin
        :type CreatorUin: int
        :param SrcPlat: 來源平台
        :type SrcPlat: str
        :param SrcAppId: 來源AppId
        :type SrcAppId: int
        :param Status: 項目狀态,0正常，-1關閉。預設項目爲3
        :type Status: int
        :param CreateTime: 創建時間
        :type CreateTime: str
        :param IsDefault: 是否預設項目，1 是，0 不是
        :type IsDefault: int
        :param Info: 描述訊息
        :type Info: str
        """
