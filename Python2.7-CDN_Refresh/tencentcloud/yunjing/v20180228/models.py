...
class DefendAttackLog(AbstractModel):
    ...
    def __init__(self):
        ...
        :type CreatedAt: str
        :param MachineIp: 目标服務器IP
        :type MachineIp: str
        :param MachineName: 目标服務器名稱
        :type MachineName: str
        :param DstIp: 目标IP
        :type DstIp: str
        :param DstPort: 目标端口
...
class DescribeAttackLogInfoResponse(AbstractModel):
    ...
    def __init__(self):
        ...
        :param SrcIp: 攻擊來源IP
        :type SrcIp: str
        :param DstPort: 攻擊目标端口
        :type DstPort: int
        :param DstIp: 攻擊目标IP
        :type DstIp: str
        :param HttpMethod: 攻擊方法
        :type HttpMethod: str
        :param HttpHost: 攻擊目标主機
        :type HttpHost: str
        :param HttpHead: 攻擊頭訊息
        :type HttpHead: str
        :param HttpUserAgent: 攻擊者浏覽器标識
...
class LoginWhiteLists(AbstractModel):
    ...
    def __init__(self):
        ...
        :param Places: 白名單地域
        :type Places: list of Place
        :param UserName: 白名單用戶（多個用戶逗号隔開）
        :type UserName: str
        :param SrcIp: 白名單IP（多個IP逗号隔開）
        :type SrcIp: str
...
class LoginWhiteListsRule(AbstractModel):
    ...
    def __init__(self):
        ...
        :param Places: 加白地域
        :type Places: list of Place
        :param SrcIp: 加白源IP，支援網段，多個IP以逗号隔開
        :type SrcIp: str
        :param UserName: 加白用戶名，多個用戶名以逗号隔開
        :type UserName: str
        :param IsGlobal: 是否對全局生效
        :type IsGlobal: bool
        :param HostIp: 白名單生效的機器
        :type HostIp: str
        :param Id: 規則ID，用于更新規則
        :type Id: int
        """
        self.Places = None
        self.SrcIp = None
