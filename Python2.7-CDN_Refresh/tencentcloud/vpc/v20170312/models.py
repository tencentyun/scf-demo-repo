...
class Address(AbstractModel):
    ...
    def __init__(self):
        ...
        :type EipAlgType: :class:`taifucloudcloud.vpc.v20170312.models.AlgType`
...
<ul style="margin:0"><li>已開通靜态單線IP白名單的用戶，可選值：<ul><li>CMCC：  </li>
<li>CTCC： 電信</li>
<li>CUCC：  </li></ul>注意：僅部分地域支援靜态單線IP。</li></ul>
        :type InternetServiceProvider: str
        :param InternetChargeType: EIP計費方式。
<ul style="margin:0"><li>已開通頻寬上移白名單的用戶，可選值：<ul><li>BANDWIDTH_PACKAGE：[共享頻寬包](https://cloud.taifucloud.com/document/product/684/15255)付費（需額外開通共享頻寬包白名單）</li>
...
<ul style="margin:0"><li>已開通頻寬上移白名單的用戶，可選值範圍取決於EIP計費方式：<ul><li>BANDWIDTH_PACKAGE：1 Mbps 至 1000 Mbps</li>
<li>BANDWIDTH_POSTPAID_BY_HOUR：1 Mbps 至 100 Mbps</li>
<li>TRAFFIC_POSTPAID_BY_HOUR：1 Mbps 至 100 Mbps</li></ul>預設值：1 Mbps。</li>
<li>未開通頻寬上移白名單的用戶，EIP出頻寬上限取決於與其綁定的實例的公網出頻寬上限，無需傳遞此參數。</li></ul>
        :type InternetMaxBandwidthOut: int
        :param AddressType: EIP類型。預設值：EIP。
<ul style="margin:0"><li>已開通Anycast公網加速白名單的用戶，可選值：<ul><li>AnycastEIP：加速IP，可參見 [Anycast 公網加速](https://cloud.taifucloud.com/document/product/644)</li></ul>注意：僅部分地域支援加速IP。</li></ul>
        :type AddressType: str
...
<li>FALSE：AnycastEIP可綁定對象爲雲伺服器、NAT閘道、高可用虛拟IP等</li></ul>預設值：FALSE。</li></ul>
        ...
        :param BandwidthPackageId: BGP頻寬包唯一ID參數。設定該參數且InternetChargeType爲BANDWIDTH_PACKAGE，則表示創建的EIP加入該BGP頻寬包並采用頻寬包計費
        :type BandwidthPackageId: str
        """
...
class AllocateAddressesResponse(AbstractModel):
    ...
    def __init__(self):
        ...
        :type AddressSet: list of str
        :param TaskId: 異步任務TaskId。可以使用[DescribeTaskResult](https://cloud.taifucloud.com/document/api/215/36271)介面查詢任務狀态。
        :type TaskId: str
        :param RequestId: 唯一請求 ID，每次請求都會返回。定位問題時需要提供該次請求的 RequestId。
        :type RequestId: str
        """
...
class AssignIpv6AddressesRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type NetworkInterfaceId: str
        :param Ipv6Addresses: 指定的`IPv6`網址清單，單次最多指定10個。與入參`Ipv6AddressCount`合並計算配額。與Ipv6AddressCount必填一個。
        :type Ipv6Addresses: list of Ipv6Address
        :param Ipv6AddressCount: 自動分配`IPv6`網址個數，内網IP網址個數總和不能超過配數。與入參`Ipv6Addresses`合並計算配額。與Ipv6Addresses必填一個。
...
class CreateBandwidthPackageResponse(AbstractModel):
    ...
    def __init__(self):
        ...
        :type BandwidthPackageId: str
        :param BandwidthPackageIds: 頻寬包唯一ID清單(申請數量大於1時有效)
...
class CreateNatGatewayRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type InternetMaxBandwidthOut: int
        :param MaxConcurrentConnection: NAT閘道並發連接上限，支援參數值：`1000000、3000000、10000000`，預設值爲`100000`。
...
class CreateNetDetectResponse(AbstractModel):
    ...
    def __init__(self):
        ...
        :type NetDetect: :class:`taifucloudcloud.vpc.v20170312.models.NetDetect`
        :param RequestId: 唯一請求 ID，每次請求都會返回。定位問題時需要提供該次請求的 RequestId。
        :type RequestId: str
        """
        self.NetDetect = None
...
class CreateNetworkAclResponse(AbstractModel):
    ...
    def __init__(self):
        ...
        :type NetworkAcl: :class:`taifucloudcloud.vpc.v20170312.models.NetworkAcl`
        :param RequestId: 唯一請求 ID，每次請求都會返回。定位問題時需要提供該次請求的 RequestId。
        :type RequestId: str
        """
...
class CreateSubnetsRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :param Tags: 指定綁定的標簽清單，注意這裏的標簽集合爲清單中所有子網對象所共享，不能爲每個子網對象單獨指定標簽，例如：[{"Key": "city", "Value": "shanghai"}]
        :type Tags: list of Tag
        """
        self.VpcId = None
        self.Subnets = None
...
<li>tag:tag-key - String - 是否必填：否 - （過濾條件）按照標簽鍵值對進行過濾。 tag-key使用具體的標簽鍵進行替換。使用請參考範例：查詢綁定了標簽的CCN清單。</li>
        :type Filters: list of Filter
        :param Offset: 偏移量
        :type Offset: int
        :param Limit: 返回數量
...
<li>tag-key - String -是否必填：否- （過濾條件）按照標簽鍵進行過濾。</li>
<li>tag:tag-key - String - 是否必填：否 - （過濾條件）按照標簽鍵值對進行過濾。 tag-key使用具體的標簽鍵進行替換。</li>
        :type Filters: :class:`taifucloudcloud.vpc.v20170312.models.Filter`
        """
        self.VpcId = None
        self.FlowLogId = None
        self.FlowLogName = None
...
class DescribeIp6AddressesRequest(AbstractModel):
    ...
    def __init__(self):
        """
        :param Ip6AddressIds: 標識 IPV6 的唯一 ID 清單。IPV6 唯一 ID 形如：`eip-11112222`。參數不支援同時指定`Ip6AddressIds`和`Filters`。
...
<li>tag-key - String -是否必填：否- （過濾條件）按照標簽鍵進行過濾。使用請參考範例2</li>
<li>tag:tag-key - String - 是否必填：否 - （過濾條件）按照標簽鍵值對進行過濾。 tag-key使用具體的標簽鍵進行替換。使用請參考範例3。</li>
...
class DescribeSecurityGroupLimitsResponse(AbstractModel):
    ...
    def __init__(self):
        ...
        :type SecurityGroupLimitSet: :class:`taifucloudcloud.vpc.v20170312.models.SecurityGroupLimitSet`
        :param RequestId: 唯一請求 ID，每次請求都會返回。定位問題時需要提供該次請求的 RequestId。
        :type RequestId: str
        """
...
class DescribeTaskResultRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type TaskId: int
        :param DealName: 計費訂單號。TaskId和DealName必填一個參數
        :type DealName: str
        """
        self.TaskId = None
        self.DealName = None
...
class DescribeTemplateLimitsResponse(AbstractModel):
    ...
    def __init__(self):
        ...
        :type TemplateLimit: :class:`taifucloudcloud.vpc.v20170312.models.TemplateLimit`
        :param RequestId: 唯一請求 ID，每次請求都會返回。定位問題時需要提供該次請求的 RequestId。
        :type RequestId: str
        """
...
class ModifyAddressInternetChargeTypeRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type AddressId: str
        :param InternetChargeType: 彈性公網IP調整目標計費模式，只支援"BANDWIDTH_PREPAID_BY_MONTH"和"TRAFFIC_POSTPAID_BY_HOUR"
        :type InternetChargeType: str
        :param InternetMaxBandwidthOut: 彈性公網IP調整目標頻寬值
        :type InternetMaxBandwidthOut: int
        :param AddressChargePrepaid: 包月頻寬網絡計費模式參數。彈性公網IP的調整目標計費模式是"BANDWIDTH_PREPAID_BY_MONTH"時，必傳該參數。
        :type AddressChargePrepaid: :class:`taifucloudcloud.vpc.v20170312.models.AddressChargePrepaid`
        """
        self.AddressId = None
        self.InternetChargeType = None
        self.InternetMaxBandwidthOut = None
...
class ModifyIp6AddressesBandwidthRequest(AbstractModel):
    ...
    def __init__(self):
        """
        :param InternetMaxBandwidthOut: 修改的目標頻寬，單位Mbps
        :type InternetMaxBandwidthOut: int
...
class ModifyNatGatewayDestinationIpPortTranslationNatRuleRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type SourceNatRule: :class:`taifucloudcloud.vpc.v20170312.models.DestinationIpPortTranslationNatRule`
        :param DestinationNatRule: 目的NAT閘道的端口轉換規則。
        :type DestinationNatRule: :class:`taifucloudcloud.vpc.v20170312.models.DestinationIpPortTranslationNatRule`
        """
        self.NatGatewayId = None
...
class ModifyNetworkAclEntriesRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type NetworkAclEntrySet: :class:`taifucloudcloud.vpc.v20170312.models.NetworkAclEntrySet`
        """
        self.NetworkAclId = None
...
class ModifySecurityGroupPoliciesRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type SecurityGroupPolicySet: :class:`taifucloudcloud.vpc.v20170312.models.SecurityGroupPolicySet`
        :param SortPolicys: 排序安全組標識。值爲True時，支援安全組排序；SortPolicys不存在或SortPolicys爲False時，爲修改安全組規則。
...
‘FAILED’：失敗。
        ...
        :type InternetMaxBandwidthOut: int
        :param MaxConcurrentConnection: 閘道並發連接上限。
        :type MaxConcurrentConnection: int
...
class NatGatewayAddress(AbstractModel):
    ...
    def __init__(self):
        ...
        :type PublicIpAddress: str
        :param IsBlocked: 資源封堵狀态。true表示彈性ip處於封堵狀态，false表示彈性ip處於未封堵狀态。
        :type IsBlocked: bool
        """
        self.AddressId = None
        self.PublicIpAddress = None
...
class ResetNatGatewayConnectionRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type NatGatewayId: str
        :param MaxConcurrentConnection: NAT閘道並發連接上限，形如：1000000、3000000、10000000。
        :type MaxConcurrentConnection: int
        """
        self.NatGatewayId = None
        self.MaxConcurrentConnection = None
