...
from taifucloudcloud.tkgdq.v20190411 import models


class TkgdqClient(AbstractClient):
    _apiVersion = '2019-04-11'
    _endpoint = 'tkgdq.taifucloudcloudapi.com'
    ...
    def DescribeEntity(self, request):
        ...
        :type request: :class:`taifucloudcloud.tkgdq.v20190411.models.DescribeEntityRequest`
        :rtype: :class:`taifucloudcloud.tkgdq.v20190411.models.DescribeEntityResponse`
    ...
    def DescribeRelation(self, request):
        ...
        :rtype: :class:`taifucloudcloud.tkgdq.v20190411.models.DescribeRelationResponse`
    ...
    def DescribeTriple(self, request):
        ...
        :type request: :class:`taifucloudcloud.tkgdq.v20190411.models.DescribeTripleRequest`
        :rtype: :class:`taifucloudcloud.tkgdq.v20190411.models.DescribeTripleResponse`
